...
class gsp_se441_qotd_attributionshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/attribution/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("attribution")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.attribution)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.attribution),'method':("DELETE")],2)
printHtmlPart(17)
})
