...
class gsp_se441_qotd_attributionindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/attribution/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(attributionList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(attributionCount ?: 0)],-1)
printHtmlPart(13)
})
